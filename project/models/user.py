...
class User(Base):
    ...
    def records_non_deleted(self, page: int = 1, per_page: int = 10, sort_by: str = "id", sort_order: str = "asc"):
        """
        Get user records
        """
        return (
            ...
            .order_by(getattr(Record, sort_by).asc() if sort_order == "asc" else getattr(Record, sort_by).desc())
